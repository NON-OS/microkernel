...
//!
//! These are the standard's own vectors, so they anchor this crate to ed25519
//! itself rather than to what the kernel implementation happened to produce.
//! The move was additionally proved byte-identical against that
//! implementation while both were in the tree, by
//! `crypto_proofs::ed25519_migration_tests`.

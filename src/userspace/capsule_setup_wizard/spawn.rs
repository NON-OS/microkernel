...
const SERVICE_NAME: &str = "app.setup_wizard";
const SERVICE_PORT: u32 = 4794;
const REPLY_INBOX: &str = "endpoint.app.setup_wizard.reply";
const REPLY_PORT: u32 = 4795;
const TARGET_TRIPLE: &str = env!("NONOS_USER_TARGET");

pub fn spawn_setup_wizard_capsule() -> Result<(), SpawnError> {
